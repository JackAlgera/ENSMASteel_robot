...
=======
    Serial.print("ptrSurPereIs ");
    Serial.println((int)actionList[currentActionIndex].ordersList[actionList[currentActionIndex].currentOrderIndex].ptrActionPere);
    Serial.print("ptrSurPereShouldBe ");
    Serial.println((int)&(actionList[currentActionIndex]));
    if (actionList[currentActionIndex].actionCompleted)
    {
        DONE[currentActionIndex] = true;
